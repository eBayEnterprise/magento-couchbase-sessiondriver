...
class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
{
    ...
    public function start($sessionName=null)
    {
		...
		break;
	    case 'couchbase':
		$config_node = Mage::getConfig()->getNode('global/session_save_couchbase');
        	$connection_string = (string)$config_node->consoleConnectionString;
        	$user = (string)$config_node->consoleUser;
        	$password = (string)$config_node->consolePassword;
		$sessionBucket = (string)$config_node->consoleSessionBucket;

		$handler = new Mage_Core_Model_Session_Abstract_CouchbaseSession($connection_string, $user, $password, $sessionBucket);
